...
class colorbrightnessWrapper {

    constructor(options) {
        if (!options || typeof options !== 'object') {
            throw new Error('Options object must be provided. See documentation: https://docs.apiverve.com/ref/colorbrightness');
        }
        ...
        this.validationRules = {"hex":{"type":"string","required":true,"format":"hexColor"}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/colorbrightness`);
        }
    }
...
module.exports = colorbrightnessWrapper;
