...
namespace APIVerve.API.ColorBrightnessCalculator
{
    ...
    /// <summary>
    /// Client for the ColorBrightnessCalculator API
    /// </summary>
    public class ColorBrightnessCalculatorAPIClient
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        : IDisposable
#endif
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/colorbrightness";
        ...
        public ColorBrightnessCalculatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ColorBrightnessCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public ColorBrightnessCalculatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, ColorBrightnessCalculatorQueryOptions options = null)
        {
            if (callback == null)
            {
        ...
        private void ValidateParams(ColorBrightnessCalculatorQueryOptions options)
        {
        ...
        public ResponseObj Execute(ColorBrightnessCalculatorQueryOptions options = null)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(ColorBrightnessCalculatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(ColorBrightnessCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(ColorBrightnessCalculatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(ColorBrightnessCalculatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(ColorBrightnessCalculatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
        ...
        /// </summary>
        private string ConstructURL(ColorBrightnessCalculatorQueryOptions options)
        {
