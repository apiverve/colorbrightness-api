...
class TestColorbrightnessAPIClient(unittest.TestCase):

    def setUp(self):
        self.api_key = 'test_api_key'
        self.client = ColorbrightnessAPIClient(self.api_key)

    @patch('apiverve_colorbrightnesscalculator.apiClient.requests.get')
