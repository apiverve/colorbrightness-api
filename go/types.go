// Package colorbrightness provides a Go client for the Color Brightness Calculator API.
//
// For more information, visit: https://apiverve.com/marketplace/colorbrightness?utm_source=go&utm_medium=readme
package colorbrightness
...
// Request contains the parameters for the Color Brightness Calculator API.
//
// Parameters:
...
// ResponseData contains the data returned by the Color Brightness Calculator API.
type ResponseData struct {
	Hex string `json:"hex"`
	Rgb RgbData `json:"rgb"`
	Luminance float64 `json:"luminance"`
	PerceivedBrightness int `json:"perceived_brightness"`
	Yiq float64 `json:"yiq"`
	IsLight bool `json:"is_light"`
	IsDark bool `json:"is_dark"`
	BrightnessCategory string `json:"brightness_category"`
	RecommendedTextColor string `json:"recommended_text_color"`
	ContrastRatioWithWhite float64 `json:"contrast_ratio_with_white"`
	ContrastRatioWithBlack float64 `json:"contrast_ratio_with_black"`
	WcagAaCompliantWithWhite bool `json:"wcag_aa_compliant_with_white"`
	WcagAaCompliantWithBlack bool `json:"wcag_aa_compliant_with_black"`
	WcagAaaCompliantWithWhite bool `json:"wcag_aaa_compliant_with_white"`
	WcagAaaCompliantWithBlack bool `json:"wcag_aaa_compliant_with_black"`
}
