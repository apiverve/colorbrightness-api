...
namespace APIVerve\Colorbrightness;
...
/**
 * Client for the Color Brightness Calculator API
 *
 * @example Basic usage
 * ```php
 ...
 * ```
 *
 * @see https://apiverve.com/marketplace/colorbrightness?utm_source=php&utm_medium=readme
 */
class Client
{
    private const BASE_URL = 'https://api.apiverve.com/v1/colorbrightness';
    ...
    {
        if ($this->debug) {
            echo "[APIVerve\ColorbrightnessClient] {$message}\n";
        }
    }
}
