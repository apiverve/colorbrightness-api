# Color Brightness Calculator Android SDK
...
```gradle
dependencies {
    implementation 'com.github.apiverve:colorbrightness-api:1.1.12'
}
```
...
```java
import com.apiverve.colorbrightness.ColorBrightnessCalculatorAPIClient;
import com.apiverve.colorbrightness.APIResponse;
import com.apiverve.colorbrightness.APIException;

// Initialize the client
ColorBrightnessCalculatorAPIClient client = new ColorBrightnessCalculatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/colorbrightness](https://docs.apiverve.com/ref/colorbrightness)
...
- **Documentation:** [https://docs.apiverve.com/ref/colorbrightness](https://docs.apiverve.com/ref/colorbrightness)
- **Issues:** [GitHub Issues](https://github.com/apiverve/colorbrightness-api/issues)
